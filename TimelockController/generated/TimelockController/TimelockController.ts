...
export class TimelockController extends ethereum.SmartContract {
  static bind(address: Address): TimelockController {
    return new TimelockController("TimelockController", address);
  }
  ...
  try_hashOperation(
    ...
    return ethereum.CallResult.fromValue(values[0].toBytes());
  }
